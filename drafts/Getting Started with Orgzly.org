...
You can customize the menu's buttons in Settings.
...
*** Internal links are also supported

Link to target with ID property:
- id:C4B2A061-ED7C-4AF1-8CF1-97ACDD0EE4D7

Same target, with a link description:
- [[id:C4B2A061-ED7C-4AF1-8CF1-97ACDD0EE4D7][Target has an ID property set]]

**** Target has an ID property set
:PROPERTIES:
:CREATED:  [2025-12-31 Wed 08:40]
:ID:       C4B2A061-ED7C-4AF1-8CF1-97ACDD0EE4D7
:END:
