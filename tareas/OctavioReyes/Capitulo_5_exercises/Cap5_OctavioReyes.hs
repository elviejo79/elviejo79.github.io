...
----------------EJERCICIOS CAPITULO 5 Octavio Reyes -----------------------
...
inorder9::BinTree a -> [a]
inorder9 BinLeaf=[]
inorder9 (BinNode x t1 t2)=inorder9 t1 ++ [x] ++ inorder9 t2

concatTree::BinTree [a]->[a]
concatTree arbol=foldr (++) [] (inorder9 arbol)
