...
#+BEGIN_SRC plantuml :file ./images/experiment_protocol.svg
@startuml
!theme mono
...
loop Baseline, Single, Concurrent, Distributed

Human -> Human: Specification phase
Human -> LLMs: Contracts, Training Test Sets
LLMs -> LLMs: Generation phase

LLMs -> Human : Working code
Human -> Human : Evaluation phase: Cost, Time, Quality

end
@enduml
#+END_SRC

#+CAPTION: Experiment protocol, for 4 experiments
#+RESULTS:
[[file:./images/experiment_protocol.svg]]
